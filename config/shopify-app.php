...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_script_tags,write_script_tags,read_inventory,write_inventory,read_themes,write_themes'),
    ...
    */
    ...
    'webhooks' => [
        ...
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://socialpixelify.auspicioussoft.com/public/webhook/theme-publish')
        ],
         [
            'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'APP_UNINSTALLED'),
            'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://socialpixelify.auspicioussoft.com/public/webhook/app-uninstalled')
        ],
